...
namespace PvZA11y
{
    public class InputRebind
    {
        ...
        {
            new RequiredInput(){intent = InputIntent.Up, description = "Directional input for menu and board navigation."},
            new RequiredInput(){intent = InputIntent.Down, description = "Directional input for menu and board navigation."},
            new RequiredInput(){intent = InputIntent.Left, description = "Directional input for menu and board navigation."},
            new RequiredInput(){intent = InputIntent.Right, description = "Directional input for menu and board navigation."},
            new RequiredInput(){intent = InputIntent.Confirm, description = "Plant placement and confirming menu choices."},
            new RequiredInput(){intent = InputIntent.Deny, description = "Shovel plants and deny menu choices."},
            ...
            new RequiredInput(){intent = InputIntent.Info1, description = "Zombie sonar, repeat dialogue messages, say upcoming zombies while on plant selector."},
            new RequiredInput(){intent = InputIntent.Info2, description = "Plant and object information for current tile."},
            new RequiredInput(){intent = InputIntent.Info3, description = "Say current sun count, and number of needy plants in zen garden."},
            ...
            new RequiredInput(){intent = InputIntent.Slot1, description = "Instantly select plant slot 1."},
            new RequiredInput(){intent = InputIntent.Slot2, description = "Instantly select plant slot 2."},
            new RequiredInput(){intent = InputIntent.Slot3, description = "Instantly select plant slot 3."},
            new RequiredInput(){intent = InputIntent.Slot4, description = "Instantly select plant slot 4."},
            new RequiredInput(){intent = InputIntent.Slot5, description = "Instantly select plant slot 5."},
            new RequiredInput(){intent = InputIntent.Slot6, description = "Instantly select plant slot 6."},
            new RequiredInput(){intent = InputIntent.Slot7, description = "Instantly select plant slot 7."},
            new RequiredInput(){intent = InputIntent.Slot8, description = "Instantly select plant slot 8."},
            new RequiredInput(){intent = InputIntent.Slot9, description = "Instantly select plant slot 9."},
            new RequiredInput(){intent = InputIntent.Slot10, description = "Instantly select plant slot 10."},
        };
