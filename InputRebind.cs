...
namespace PvZA11y
{
    public class InputRebind
    {
        ...
        RequiredInput[] requiredInputs = new RequiredInput[]
        {
            ...
            new RequiredInput(){intent = InputIntent.Info2, description = "Plant and object information for current tile, delete user when in user picker dialogue, say zen garden plant status"},
