...
namespace PvZA11y
{
    ...
    public static class Consts
    {
        ...
        public static string[] plantDescriptions = new string[]{
            ...
            "Shoots short-ranged spores at the enemy",
            ...
            "Destroys a large area, leaving a crater in its wake",
            ...
            "Aquatic plant that shoots short-ranged spores",
            ...
            "Releases heavy fumes in an area around itself",
            "Attacks any lane and shoots down balloon zombies",
        ...
        public static string[] plantFullDescriptions = new string[]{
            ...
            "Jalapenos destroy an entire lane of zombies. Damage: massive. Range: all zombies in a lane. Usage: single use, instant.\"NNNNNGGGGGG!!!!!!!!\" Jalapeno says. He's not going to explode, not this time. But soon. Oh, so soon. It's close. He knows it, he can feel it, his whole life's been leading up to this moment.",
            ...
            "Cactuses shoot spikes that can hit both ground and air targets. Damage: normal. Range: ground and air. She's prickly, sure, but Cactus's spikes belie a spongy heart filled with love and goodwill. She just wants to hug and be hugged. Most folks can't hang with that, but Cactus doesn't mind. She's been seeing an armadillo for a while and it really seems to be working out.",
            ...
            "Starfruits shoot stars in 5 directions. Damage: normal. Range: 5 directions.\"Aw, man,\" says Starfruit. \"I went to the dentist the other day and he said I have four cavities. I've got --count it-- ONE tooth! Four cavities in one tooth? How does this happen?\"",
