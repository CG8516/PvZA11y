...
namespace PvZA11y.Widgets
{
    class OptionsMenu : Dialog
    {
        ...
        {
            string continueString = memIO.mem.ReadString(ptrChain + memIO.ptr.optionsMenuContinueOffset + memIO.ptr.widgetDialogStringOffset, "", 32, true, Program.encoding);  //"OK" at main menu, "Return To Game" in game
        ...
        public override void Interact(InputIntent intent)
        {
            ...
            string continueString = memIO.mem.ReadString(pointerChain + memIO.ptr.optionsMenuContinueOffset + memIO.ptr.widgetDialogStringOffset, "", 32, true, Program.encoding);  //"OK" at main menu, "Return To Game" in game
        ...
        protected override string? GetContent()
        {
            ...
            string titleString = "";
            if (titleLen <= 15)
                titleString = memIO.mem.ReadString(pointerChain + memIO.ptr.dialogTitleStrOffset, "", 32, true, Program.encoding);
            else
                titleString = memIO.mem.ReadString(pointerChain + memIO.ptr.dialogTitleStrOffset + ",0", "", 32, true, Program.encoding);
